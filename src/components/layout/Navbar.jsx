...
//   // Note: 'isAuthenticated' now comes as a prop (true/false)
...
//           <Link
//             to="/test"
//             className="relative group px-1 py-2 hover:text-blue-600"
//           >
//             Test
//             <span className="absolute left-0 -bottom-1 w-0 group-hover:w-full h-0.5 bg-blue-600 transition-all"></span>
//           </Link>
...
//       {/* Mobile Menu */}
//       <div
//         className={`md:hidden bg-white shadow-md overflow-hidden transition-[max-height] duration-500 ease-in-out ${isOpen ? "max-h-96" : "max-h-0"
//           }`}
//       >
